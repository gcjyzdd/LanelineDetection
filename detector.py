...
#        plt.show()
    ...
    def sanityCheck(self, left_fit, right_fit):
        ...
        a1 = 0.1
        a2 = 1 - a1
        if ratio > 5 or (dmax > 1200 or dmin < 400):  # or (dmax-dmin)/dmin > 0.5
...
def testKF():
    ...
    white_output = 'output/project_output_v2_kf_tmp.mp4'
    ...
    clip1 = VideoFileClip("./extendedOutput.avi")  # .subclip(18,48)
